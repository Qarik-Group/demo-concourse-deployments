...
To create a new environment (called `us-east-prod-concourse`):
...
To download a new version of the kit, and deploy it:
    ...
    genesis download concourse [version] # omitting version downloads the latest
...
- [concourse-genesis-kit][2] - Details on the kit used in this repo,
...
[2]: https://github.com/genesis-community/concourse-genesis-kit
